...
class Tutor_Lms_Course_Carousel extends Module_Base {
	...
	private function register_section_controls() {
        ...
        //Global Navigation Controls
		    ep_navigation_controls($this);

		//Global Carousel Srttings Controls
		ep_carousel_settings($this);
		...
		ep_navigation_style_controls($this, 'tutor-course');
	}
    ...
    public function render_header() {
		...
		//Global Function
		render_header_attribute($this, 'tutor-course');
